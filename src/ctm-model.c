...
GtkTreeModel *
ctm_model_get_all_people (CtmModel *self)
{
...
GtkTreeModel *
ctm_model_get_all_projects (CtmModel *self)
{
  GtkListStore *store   = NULL;
...
GtkTreeModel *
ctm_model_get_all_tasks (CtmModel *self)
{
  GtkListStore *store = NULL;
  CtmTask      *task  = NULL;
  GPtrArray    *data  = NULL;
...
GtkTreeModel *
ctm_model_get_all_events (CtmModel *self)
{
  GtkListStore *store = NULL;
  CtmEvent     *event = NULL;
  GPtrArray    *data  = NULL;
